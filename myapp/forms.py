...
choices_month=[('1','Jan'),('2','Feb'),('3','Mar'),('4','April'),('5','May')]
...
class SampleForm(forms.Form):
    first_name=forms.CharField( max_length=20, required=True,label="First Name", help_text='Note:space and spl characters are not allowed')
    last_name=forms.CharField( max_length=20, required=False,label="Last Name")
    email=forms.EmailField(max_length=100, required=True,label="Email")
    phno=forms.IntegerField(max_value=9999999999, required=True,min_value=600000000000,label="phno")
    #phno=forms.RegexField(max_length=10,min_length=10, regex="[6-9]\d{9}", required=True)
